-- Function: parsel(text, text, text, text, text, integer)

-- DROP FUNCTION parsel(text, text, text, text, text, integer);
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION parsel(text, text, text, text, text, integer)
  OWNER TO postgres;
