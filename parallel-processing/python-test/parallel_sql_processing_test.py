...
Purpose:     uses parallel processing in Postgres to get bdy tags for all points
...
def get_settings(args):
    ...
    settings["the_sql_file"] = "the_query.sql"
...
def main():
    ...
    while current_child_table_num < num_partitions:
        ...
        sql_list.append(settings['sql'] % (partition_start_value, partition_end_value))
